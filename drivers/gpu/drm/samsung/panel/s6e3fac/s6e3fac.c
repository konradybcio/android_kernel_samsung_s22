...
__visible_for_testing int __init s6e3fac_panel_init(void)
{
...
__visible_for_testing void __exit s6e3fac_panel_exit(void)
{
	deregister_common_panel(&s6e3fac_rainbow_g0_panel_info);
	deregister_common_panel(&s6e3fac_rainbow_r0_panel_info);
}

module_init(s6e3fac_panel_init)
module_exit(s6e3fac_panel_exit)
